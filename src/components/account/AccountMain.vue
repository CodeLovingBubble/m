<template>
    <div class="account-layout">
        ...
        <aside class="account-aside">
            <div class="profile"
                style="background-image: url(&quot;https://cdn.web-global.fds.api.mi-img.com/mcfe--mi-account/static/static/media/background.fdf39507..png&quot;);">
                <div class="avatar">
                    <img src="https://cdn.web-global.fds.api.mi-img.com/mcfe--mi-account/static/static/media/avatar.d443cc57.svg"
            ...
            <nav class="account-nav">
                <ul>
                    <li v-for="(item, index) in navList" :key="index" :class="{ active: currentTab === item.key }"
